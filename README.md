...
🏐 View Live Standings (Replace with your actual URL)
About
...
Data Source
Standings data is sourced from the official PSR Volleyball Power League page.
Note: Standings are typically updated every Tuesday following each play date.
How to Update Standings
When new standings are posted (check the PSR website on Tuesdays after play dates), follow these steps:
Option 1: Manual Update (Easiest)

Download the latest U12 standings PDF from https://www.psrvb.org/power-league
Open index.html in a text editor
Find the standingsData array (around line 245)
Update the team rankings and points to match the new PDF
Save the file
Upload to GitHub (drag & drop in the repository, or commit via Git)

Option 2: Using Git Command Line
bash# Clone the repository (first time only)
...
Contact
For questions about the Power League itself, visit PSR Volleyball.
